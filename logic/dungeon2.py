...
class Dungeon2:
    def __init__(self, options, world_setup, r):
        ...
        dungeon2_map_chest = Location(2).add(DungeonChest(0x12E)).connect(dungeon2_l2, AND(r.attack_hookshot_powder, OR(FEATHER, HOOKSHOT)))  # map chest
        dungeon2_r2 = Location(2).connect(entrance, r.fire)
        Location(2).add(DroppedKey(0x132)).connect(dungeon2_r2, r.attack_skeleton)
